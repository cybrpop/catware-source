...
/* 36 */           continue;  int percent = DamageUtil.getRoundedDamage(stack);
...
/*    */           } 
/* 43 */           this.entityArmorArraylist.put(player, Integer.valueOf(player.field_71071_by.field_70460_b.indexOf(stack)));
/*    */         } 
/* 45 */         if (!this.entityArmorArraylist.containsKey(player) || ((Integer)this.entityArmorArraylist.get(player)).intValue() != player.field_71071_by.field_70460_b.indexOf(stack) || percent <= ((Integer)this.armorThreshhold.getValue()).intValue())
/*    */           continue; 
/* 47 */         this.entityArmorArraylist.remove(player);
/*    */       } 
...
/*    */         continue; 
/* 51 */       this.entityArmorArraylist.remove(player);
/*    */     } 
/*    */   }
/*    */   
...
/* 57 */       return "helmet is";
/*    */     }
/* 59 */     if (stack.func_77973_b() == Items.field_151163_ad || stack.func_77973_b() == Items.field_151171_ah || stack.func_77973_b() == Items.field_151030_Z || stack.func_77973_b() == Items.field_151023_V || stack.func_77973_b() == Items.field_151027_R) {
/* 60 */       return "chestplate is";
/*    */     }
/* 62 */     if (stack.func_77973_b() == Items.field_151173_ae || stack.func_77973_b() == Items.field_151149_ai || stack.func_77973_b() == Items.field_151165_aa || stack.func_77973_b() == Items.field_151022_W || stack.func_77973_b() == Items.field_151026_S) {
/* 63 */       return "leggings are";
/*    */     }
/* 65 */     return "boots are";
/*    */   }
/*    */ }
...
/* Location:              C:\Users\taruv\Documents\Client\Catware_1.0_Official_Release_UwU.jar!\me\earth\phobos\features\modules\combat\ArmorMessage.class
